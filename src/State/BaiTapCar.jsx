            ...
            <div className="row">
                ...
                <div className="col-4 d-flex flex-column" style={{ gap: 20 }}>
                    <button className="btn btn-dark"
                        // onClick={() => { setImgSrc('./images/car/black-car.jpg') }} 
                    ...
                    <button className="btn btn-danger"
                        // onClick={() => { setImgSrc('./images/car/red-car.jpg') }} 
                    ...
                    <button className="btn btn-secondary"
                        // onClick={() => { setImgSrc('./images/car/silver-car.jpg') }}
                        // onClick={() => handleImgSrc('silver')}
                        onClick={handleImg('silver')}
                    >
                        Silver
                    </button>
                    <button className="btn text-white" style={{ background: 'grey' }}
                        // onClick={() => { setImgSrc('./images/car/steel-car.jpg') }}  
