...
const DemoState = () => {
  ...
  // 7. Trong 1 component có thể tạo đc ko giới hạn số lượng state
    ...
    <div className="container mt-5">
      ...
      {isLogin ?
        (<div className="fs-3 mb-5">
          Hello Hải{' '}
          <button className="btn btn-danger ms-4" onClick={() => { handleLogin(false) }}>
            Đăng xuất
          </button>
        </div>) : (
          <button className="btn btn-success" onClick={() => { handleLogin(true) }}>
            Đăng nhập
          </button>
        )}
